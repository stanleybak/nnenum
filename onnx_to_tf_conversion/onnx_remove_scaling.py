...
def load_zero_images(filename, is_zero=True):
    ...
    elif 'cifar_' in filename:
        # OVAL cifar
        mean_list = [0.485, 0.456, 0.406]
        sigma_list = [0.225, 0.225, 0.225]
    else:
...
def model_convert(onnx_filename):
    ...
    if 'cifar10' in onnx_filename:
        # ETH CIFAR
        mean_list = [0.4914, 0.4822, 0.4465]
        sigma_list = [0.2023, 0.1994, 0.2010]
    elif 'cifar_' in onnx_filename:
        # OVAL cifar
        mean_list = [0.485, 0.456, 0.406]
        sigma_list = [0.225, 0.225, 0.225]
    else:
...
def glue_models(model1, model2):
    ...
    # use ir_version 3 because we don't add inputs as initializers
